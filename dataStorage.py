class dataStorage():
    ...
    def __init__(self, data):
        ...
        self.data.occupiedSquareFill = "pink"
    ...
    def firstClickHand(self, handColumn):
        self.data.message1 = "Clicked letter in hand. Click on the block on the board."
    ...
    def emptyHandBoardSwitch(self, spot):
        ...
        self.data.occupiedHandLocations.remove(handColumn)  
        self.data.emptyHandLocations.append(handColumn)       
    ...
    def occupiedHandHandSwitch(self, handColumn):
        ''' Occupied hand and occupied hand '''         # switches the letter order in letterHand
    ...
    def emptyBoardBoardSwitch(self, spot):
        ''' Occupied hand and empty hand '''         # first click location is the spot
    ...
    def mousePressed(self, event):
        ...
        if (column > 14 or column < 0):
            column = 225        # if outside of board
        ...
        if self.data.canSwitchFromHand:
            if onEmptySpot: self.emptyHandBoardSwitch(spot)     # first clicked
            ...
            if occupiedInHand: self.occupiedBoardHandSwitch(handColumn)    # first clicked
